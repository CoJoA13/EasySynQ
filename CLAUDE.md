...
> COMPLETE**; the remaining §2A item (the QMS-tree import) needs the owner at the site, and the
> §4 backlog (user creation · permission visibility · import picker · user profile) is
> brainstorm-first.
