...
> `docs/00-overview.md` (front door) and `docs/decisions-register.md` (binding decisions, R1–R63).
...
- **`docs/decisions-register.md`** — AUTHORITATIVE (R1–R63); supersedes conflicting section text. Read before any design call.
...
> — PR #427 squash `958f00d`. **Next (owner-approved 2026-08-03): make the compliance checklist's
> ★ coverage subtree-aware** so a descendant-covered ★ clause stops reading GAP (design-check
> whether exactness is register-locked first — possible R63).
