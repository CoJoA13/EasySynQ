...
- Database/manifest archives (AES-256-GCM when a real backup key is configured; otherwise plaintext
  with secret-bearing legs omitted; no object bytes), source-store-dependent **restore integrity
