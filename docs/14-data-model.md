...
| `storage_config` | `id` PK, `org_id`, `pg_dsn_ref`, `minio_endpoint`, `bucket_documents`, `bucket_renditions`, `bucket_records`, `bucket_staging`, `worm_verified_at`, `sse_enabled`, `mirror_path`, `mirror_layout` enum(`by_clause`,`by_process`,`hybrid`), `mirror_released_only` (forced true) | `08 §7`, `04 §10`. Mirror is read-only, regenerable, never backup-critical. |
...
| `supplier` | `id` PK, `org_id`, `name`, `status`, `re_eval_due` | Cl 8.4; evaluations are `record`s. |
