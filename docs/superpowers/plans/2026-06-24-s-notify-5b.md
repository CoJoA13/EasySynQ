...
- [ ] `/check-api` — ruff + format-check + mypy-strict + unit (the new integration tests run under `-m integration` with Docker; CI-authoritative in that development environment).
